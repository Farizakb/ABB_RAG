# backend/rag/conftest.py
# ruff: noqa: RUF001 -- genuine Azerbaijani fixture text (dotless-i and
# friends) in seeded_corpus; see backend/rag/tests/test_chunking.py for the
# same convention.
...
def _reachable(url: str) -> str:
    ...
    `pytest backend/rag` is actually run, dialling that name unchanged
